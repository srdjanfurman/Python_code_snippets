...
# class TestSerialOld(unittest.TestCase):
#     """TestSerialOld class"""
#
#     def setUp(self) -> None:
#         pass
#         # self.patcher_1 = patch('serial_dev.Serial')
#         # self.patcher_2 = patch('serial_dev.Serial.isOpen')
#         # self.patcher_3 = patch('serial_dev.Serial.in_waiting')
#         # self.patcher_4 = patch('serial_dev.Serial.read')
#
#         # self.data = iter([
#         #     b'[', b'1', b'2'
#         # ])
#
#         # self.serial = self.patcher_1.start()
#         # self.isOpen = self.patcher_2.start()
#         # self.in_waiting = self.patcher_3.start()
#         # self.read = self.patcher_4.start()
#
#     def tearDown(self) -> None:
#         pass
#         # self.patcher_1.stop()
...
#         """test_serial"""
#
#         # def read(): return next(self.data)
#
#         # self.serial.return_value.isOpen.return_value = False
#         # self.serial.return_value.in_waiting.return_value = 1
#         # self.serial.return_value.read.return_value = read()  # b'['
#         # self.read.return_value = b'['
#
#         # self.isOpen.return_value = False
#         # self.in_waiting.return_value = 2
#
#         ser_dev = SerialDevice('/dev/pts/3')
#         ser_dev.open_serial_device()
#
#         # self.serial.return_value.read.return_value = generate_test_data(self.data)
#         data = ser_dev.read_serial_device()
#         print(data)
#
#         ser_dev.close_serial_device()
#
#         # self.assertTrue(self.serial.called)
